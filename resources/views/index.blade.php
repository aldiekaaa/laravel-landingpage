...
<body>
                ...
                <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
                    <div class="container flex flex-wrap items-center mx-auto">
                        <a href="#" class="flex items-center">
                            <span
                                class="self-center text-2xl font-bold whitespace-nowrap dark:text-white italic">ALDI EKA</span>
                        </a>
                            ...
                            <ul
                                ...
                                <li>
                                    <a href="#"
                                        ...
                                        aria-current="page">Data Produk</a>
                                </li>
                                <li>
                                    <a href="#"
    ...
    <div class="mt-24 container mx-auto relative overflow-x-auto shadow-md sm:rounded-lg">
